...
import 'package:nazerin_project/ruler_map/model/model_polygon.dart';
import 'package:nazerin_project/ruler_map/model/model_polyline.dart';
import 'package:nazerin_project/ruler_map/services_rulermap/api.dart';
import 'package:nazerin_project/ruler_map/utils/math.dart';
import 'package:nazerin_project/ruler_map/utils/paintercircle.dart';
import 'package:nazerin_project/ruler_map/utils/paintermarker.dart';

class ProviderMaps with ChangeNotifier {
  final LatLng _initialposition =
      const LatLng(35.74230670956617, 51.33455236177664);
  LatLng? _positiondirec;
  String? distance;
  String? _area;
  String? _direction;
  final bool _circledata = false;
  ...
  Future<Uint8List> _paintermarker(String label) async {
    ...
    paintermarker.paint(canvas, const Size(250, 100));
  ...
  Future<Uint8List> _paintercircle() async {
    ...
    paintermarker.paint(canvas, const Size(30, 30));
